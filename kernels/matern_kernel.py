...
class MaternKernel(Kernel):
    ...
    * :math:`K_\nu` is a modified Bessel function.
    ...
    See :class:`gpytorch_mini.kernels.Kernel` for descriptions of the lengthscale options.

    .. note::

        This kernel does not have an `outputscale` parameter. To add a scaling parameter,
        decorate this kernel with a :class:`gpytorch_mini.kernels.ScaleKernel`.
    ...
    :type lengthscale_prior: ~gpytorch_mini.priors.Prior, optional
    :param lengthscale_constraint: (Default: `Positive`) Set this if you want
        to apply a constraint to the lengthscale parameter.
    :type lengthscale_constraint: ~gpytorch_mini.constraints.Interval, optional
    ...
    Example:
        ...
        >>> covar_module = gpytorch_mini.kernels.ScaleKernel(gpytorch_mini.kernels.MaternKernel(nu=0.5))
        >>> # Non-batch: ARD (different lengthscale for each input dimension)
        >>> covar_module = gpytorch_mini.kernels.ScaleKernel(gpytorch_mini.kernels.MaternKernel(nu=0.5, ard_num_dims=5))
        ...
        >>> covar_module = gpytorch_mini.kernels.MaternKernel(nu=0.5, batch_shape=torch.Size([2])
