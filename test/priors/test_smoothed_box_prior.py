...
class TestSmoothedBoxPrior(BaseTestCase):
    ...
    def test_smoothed_box_prior_log_prob(self, cuda=False):
        ...
        self.assertAllClose(prior._M, torch.full_like(prior.a, 1.6073))
        ...
        self.assertAllClose(prior.log_prob(t), log_prob_expected)
    ...
    def test_sample(self) -> None:
        ...
        self.assertAllClose(
            torch.as_tensor(n_gaussian / n_samples), ratio_gaussian_mass, atol=0.005
        )
